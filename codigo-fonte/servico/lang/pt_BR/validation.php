...
return [
    ...
    | classe validadora. Algumas destas regras têm várias versões, como as regras
    | de tamanho. Sinta-se livre para ajustar cada uma dessas mensagens aqui.
    |
    */
    ...
    */
    ...
    'custom' => [
        'cpf' => [
            ...
            'size' => 'O CPF deve ter 11 dígitos.',
        ...
        'voto' => [
            'required' => 'O voto é obrigatório.',
            'boolean' => 'O voto deve ser sim ou não.',
        ],
        'numero' => [
            'max' => 'O número não pode ter mais de :max caracteres.',
        ],
        'nome_sindicato' => [
            'required' => 'O nome do sindicato é obrigatório.',
            'max' => 'O nome do sindicato não pode ter mais de :max caracteres.',
        ],
    ],
